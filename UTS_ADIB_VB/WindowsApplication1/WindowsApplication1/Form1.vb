...
Public Class Form1
    ...
    Private Sub Btsend_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btsend.Click
        ...
        Try
            Call OpenKoneksi()
            Dim query_id As String = "SELECT MAX(RequestId)+1 AS MXID FROM adibtransportasi"
            ...
            query = "INSERT INTO adibtransportasi (RequestId,NameRequestor,RequestorId,Unit,DateIssue,UnitDestination,acRegis,Transportation,Phone,Instruction) " & _
    ...
    Private Sub show_request()
        ...
        Try
            Call OpenKoneksi()
            Dim query_id As String = "select * from adibtransportasi"
            cmd = New SqlCommand(query_id, conn)
            dr = cmd.ExecuteReader
    ...
    Private Sub DeleteToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DeleteToolStripMenuItem.Click
        ...
        Try
            ...
            Call OpenKoneksi()
            Dim query As String = "delete from adibtransportasi where RequestId='" + RequestId + "'"
            cmd = New SqlCommand(query, conn)
            dr = cmd.ExecuteReader
            Call CloseKoneksi()
            dr.Close()
    ...
    Private Sub EditToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EditToolStripMenuItem.Click
        ...
        Try
            ...
            Call OpenKoneksi()
            query = "SELECT adibtransportasi WHERE RequestId='" + RequestId + "'"
    ...
    Private Sub Btupdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btupdate.Click
        ...
        Try
            ...
            Call OpenKoneksi()
            query_gl = "UPDATE adibtransportasi SET " & _
